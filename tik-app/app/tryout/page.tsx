...
const PROGRESS_STEPS = [
  { label: 'Анализируем пространство вашего участка...', tip: 'Тик Grade A — что это значит?', tipBody: 'Grade A — высший сорт тика. Равномерный цвет, минимум сучков, влажность 12%. Служит 25–40 лет без гниения.' },
  { label: 'Подбираем масштаб и перспективу...', tip: 'Как ухаживать — 5 минут в год', tipBody: 'Раз в год нанесите тиковое масло мягкой тряпкой. Цвет постепенно станет серебристо-серым — это нормально и красиво.' },
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
              <div>
                ...
                <p style={{ fontSize: 16, color: 'var(--muted)', lineHeight: 1.7, marginBottom: 32 }}>
                  Слева — терраса клиента в Подмосковье. AI расставил диван «Форест» и кресла, подобрав масштаб и освещение. Результат за 4 минуты.
                </p>
