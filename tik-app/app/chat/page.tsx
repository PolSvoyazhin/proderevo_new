...
const AI_RESPONSES: Record<string, string> = {
  ...
  'подмосковье': 'Для Подмосковья тик Grade A подходит отлично — выдерживает до −40°C без растрескивания. Рекомендую раз в сезон наносить тиковое масло. Со временем цвет перейдёт в серебристо-серый — это нормальное патинирование, не повреждение.',
  'grade': 'Grade A — высший сорт тика: равномерный цвет, минимум сучков, влажность 12%, без расслоений. Grade B дешевле на 25-30%, но имеет больше сучков и неоднородный цвет. Для premium outdoor рекомендуем только Grade A — на нём и строится вся коллекция ТИК.',
  'уход': 'Уход минимальный: раз в год протрите тиковым маслом — занимает 20–30 минут. Зимой можно накрыть чехлами или оставить под открытым небом — тик это выдержит. Не нужно заносить в дом.',
  'цена': 'Диван «Форест» 3-местный — от 380 000 руб. Кресло — от 145 000. Полный комплект «Терраса» (диван + 2 кресла + стол) — от 720 000 руб., это выгоднее на 12% чем покупать отдельно. Все цены включают доставку по России.',
  'урал': 'Да, тик Grade A работает на Урале и в Сибири. Температурный диапазон −40°C до +50°C. Единственная рекомендация — раз в год обрабатывать маслом до наступления зимы. Клиенты из Екатеринбурга уже 5+ лет используют без нареканий.',
